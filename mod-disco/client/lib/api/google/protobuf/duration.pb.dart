...
class Duration extends $pb.GeneratedMessage with $mixin.DurationMixin {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Duration', package: const $pb.PackageName('google.protobuf'), createEmptyInstance: create, toProto3Json: $mixin.DurationMixin.toProto3JsonHelper, fromProto3Json: $mixin.DurationMixin.fromProto3JsonHelper)
    ..aInt64(1, 'seconds')
