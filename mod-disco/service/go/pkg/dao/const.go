...
const (
	...
	SurveyProjectColumnsType = `TEXT, TEXT, TEXT, TEXT, INT, INT`
	...
	SurveyUsersColumnsType   = `TEXT, TEXT, TEXT, TEXT, TEXT, INT, INT`
	...
	DiscoProjectColumnsType  = `TEXT, TEXT, TEXT, TEXT, INT, INT, TEXT, INT, INT, INT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, INT, INT `
	DefaultLimit             = 50
