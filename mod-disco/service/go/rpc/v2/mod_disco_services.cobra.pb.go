...
func _SurveyServiceNewDiscoProjectCommand(cfg *client.Config) *cobra.Command {
	...
	flag.BytesBase64SliceVar(cmd.PersistentFlags(), &req.ImageUploadArrays, cfg.FlagNamer("ImageUploadArrays"), "@inject_tag: fake:\"skip\" yaml:\"image_upload_arrays,omitempty\"")
