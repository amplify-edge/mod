...
func (x *UserNeedsValuePlusAccount) GetCreatedAt() *timestamp.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
func (x *SupportRoleValuePlusAccount) GetCreatedAt() *timestamp.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
var file_mod_disco_models_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x72, 0x69, 0x65, 0x73, 0x22, 0xa5, 0x02, 0x0a, 0x11, 0x53, 0x74, 0x61, 0x74, 0x69,
	...
	0x28, 0x09, 0x52, 0x0a, 0x6e, 0x65, 0x78, 0x74, 0x50, 0x61, 0x67, 0x65, 0x49, 0x64, 0x42, 0x3a,
