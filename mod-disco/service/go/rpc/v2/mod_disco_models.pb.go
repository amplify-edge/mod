...
type SurveyProject struct {
	...
	SurveySchemaTypes   []byte               `protobuf:"bytes,4,opt,name=survey_schema_types,json=surveySchemaTypes,proto3" json:"survey_schema_types,omitempty"` // SurveySchemaType in JSON format
	SurveyFilterTypes   []byte               `protobuf:"bytes,5,opt,name=survey_filter_types,json=surveyFilterTypes,proto3" json:"survey_filter_types,omitempty"` // SurveyFilterType in JSON format
...
func (x *SurveyProject) GetSysAccountProjectId() string {
	if x != nil {
...
type SurveyUser struct {
	...
	SurveyProjectId     string               `protobuf:"bytes,2,opt,name=survey_project_id,json=surveyProjectId,proto3" json:"survey_project_id,omitempty"`
	SysAccountAccountId string               `protobuf:"bytes,3,opt,name=sys_account_account_id,json=sysAccountAccountId,proto3" json:"sys_account_account_id,omitempty"`
...
func (x *SurveyUser) GetSurveyProjectId() string {
	if x != nil {
		return x.SurveyProjectId
	}
	return ""
...
func (x *SurveyUser) GetSysAccountAccountId() string {
	if x != nil {
...
type IdRequest struct {
	...
	SurveyUserId    string `protobuf:"bytes,1,opt,name=survey_user_id,json=surveyUserId,proto3" json:"survey_user_id,omitempty"`
	SysAccountId    string `protobuf:"bytes,2,opt,name=sys_account_id,json=sysAccountId,proto3" json:"sys_account_id,omitempty"`
...
func (x *IdRequest) GetSysAccountId() string {
	if x != nil {
		return x.SysAccountId
	}
	return ""
}
...
type NewSurveyProjectRequest struct {
	...
	SysAccountProjectId string `protobuf:"bytes,1,opt,name=sys_account_project_id,json=sysAccountProjectId,proto3" json:"sys_account_project_id,omitempty"`
...
func (x *NewSurveyProjectRequest) GetSysAccountProjectId() string {
	if x != nil {
		return x.SysAccountProjectId
	}
	return ""
...
type NewSurveyUserRequest struct {
	...
	SurveyProjectId   string `protobuf:"bytes,1,opt,name=survey_project_id,json=surveyProjectId,proto3" json:"survey_project_id,omitempty"`
	SysAccountUserId  string `protobuf:"bytes,2,opt,name=sys_account_user_id,json=sysAccountUserId,proto3" json:"sys_account_user_id,omitempty"`
...
func (x *NewSurveyUserRequest) GetSurveyProjectId() string {
	if x != nil {
		return x.SurveyProjectId
	}
	return ""
...
func (x *NewSurveyUserRequest) GetSysAccountUserId() string {
	if x != nil {
		return x.SysAccountUserId
	}
	return ""
}
...
func (x *UpdateSurveyUserRequest) GetSurveySchemaTypes() []byte {
	if x != nil {
		return x.SurveySchemaTypes
	}
	return nil
...
func (x *UpdateSurveyUserRequest) GetSurveyFilterTypes() []byte {
	if x != nil {
		return x.SurveyFilterTypes
	}
	return nil
...
var file_mod_disco_models_proto_rawDesc = []byte{
	...
	0x22, 0xc6, 0x02, 0x0a, 0x0d, 0x53, 0x75, 0x72, 0x76, 0x65, 0x79, 0x50, 0x72, 0x6f, 0x6a, 0x65,
	...
	0x75, 0x72, 0x76, 0x65, 0x79, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x64, 0x12, 0x33,
	0x0a, 0x16, 0x73, 0x79, 0x73, 0x5f, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x70, 0x72,
	0x6f, 0x6a, 0x65, 0x63, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x13,
	0x73, 0x79, 0x73, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63,
	0x74, 0x49, 0x64, 0x12, 0x2e, 0x0a, 0x13, 0x73, 0x75, 0x72, 0x76, 0x65, 0x79, 0x5f, 0x73, 0x63,
	0x68, 0x65, 0x6d, 0x61, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c,
	...
	0x6c, 0x74, 0x65, 0x72, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0c,
	...
	,
	...
	0x52, 0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x83, 0x01, 0x0a, 0x09,
	0x49, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x24, 0x0a, 0x0e, 0x73, 0x75, 0x72,
	...
	0x24, 0x0a, 0x0e, 0x73, 0x79, 0x73, 0x5f, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x69,
	0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x73, 0x79, 0x73, 0x41, 0x63, 0x63, 0x6f,
	0x75, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x2a, 0x0a, 0x11, 0x73, 0x75, 0x72, 0x76, 0x65, 0x79, 0x5f,
	0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0f, 0x73, 0x75, 0x72, 0x76, 0x65, 0x79, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x49,
	...
	0x64, 0x22, 0xae, 0x01, 0x0a, 0x17, 0x4e, 0x65, 0x77, 0x53, 0x75, 0x72, 0x76, 0x65, 0x79, 0x50,
	0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x33, 0x0a,
	0x16, 0x73, 0x79, 0x73, 0x5f, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x70, 0x72, 0x6f,
	0x6a, 0x65, 0x63, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x13, 0x73,
	...
	0x65, 0x73, 0x22, 0xd1, 0x01, 0x0a, 0x14, 0x4e, 0x65, 0x77, 0x53, 0x75, 0x72, 0x76, 0x65, 0x79,
	0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x2a, 0x0a, 0x11, 0x73,
	...
	0x6f, 0x6a, 0x65, 0x63, 0x74, 0x49, 0x64, 0x12, 0x2d, 0x0a, 0x13, 0x73, 0x79, 0x73, 0x5f, 0x61,
	0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x73, 0x79, 0x73, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	0x55, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x2e, 0x0a, 0x13, 0x73, 0x75, 0x72, 0x76, 0x65, 0x79,
	0x5f, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x18, 0x03, 0x20,
	...
	,
	...
	0x72, 0x49, 0x64, 0x12, 0x2e, 0x0a, 0x13, 0x73, 0x75, 0x72, 0x76, 0x65, 0x79, 0x5f, 0x73, 0x63,
	...
	0x52, 0x11, 0x73, 0x75, 0x72, 0x76, 0x65, 0x79, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x54, 0x79,
	0x70, 0x65, 0x73, 0x42, 0x3a, 0x5a, 0x38, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
